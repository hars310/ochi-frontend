...
function Banner() {
  return (
    <div data-scroll data-scroll-speed=".2"  className=" w-full min-h-[100vh] sticky">
        <div className="mb-32 flex gap-4 px-12">
            <div className="w-[48%] h-[60vh] rounded-lg flex-col  flex items-center  justify-center bg-[#154741]">
                <div className="  text-green-500 mt-12 ">
                <svg
          width="200"
          height="200"
          viewBox="0 0 72 30"
        ...
        >
          ...
          ></path>
                ...
                <div className="px-4 w-full mt-16  ">
                    <div className="border-[1.5px] text-sm border-green-500 w-fit rounded-full p-1 px-4 text-green-500">
                    ©️ 2019-2022
                    </div>
                </div>
            </div>
            <div className="w-[25%] h-[60vh] rounded-lg  flex flex-col items-center justify-center bg-zinc-800">
            <div className="  text-green-500  my-16  ">
            <img className="h-[150%]" src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
                </div>
                <div className="px-4 pt-10 w-full  mt-16   ">
                    <div className="border-[1.5px] text-sm border-white w-fit rounded-full p-1 px-4 text-white">
                    RATING 5.0 ON CLUTCH
                    </div>
                </div>
            </div>
            <div className="w-[25%] h-[60vh] rounded-lg  flex flex-col items-center justify-center bg-[#212121]">
            <div className="  text-green-500  flex flex-col items-center justify-center">
            <img className="h-[50%]" src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                </div>
